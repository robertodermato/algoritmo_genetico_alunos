...
public class CrossoverOBX {
    ...
    private int nivelDeVerbosidade;

    public CrossoverOBX(double taxaDeCromossomosQuesofreraoCrossoverRecebida, double taxaDeGenesQueSofreraoCrossoverRecebida,
                        Integer [][] populacaoRecebida, int nivelDeVerbosidadeRecebido) {
        //taxaDeCromossomosQueSofreraoCrossover = taxaDeCromossomosQuesofreraoCrossoverRecebida; Essa variável não está sendo usada
    ...
    public void doCrossoverOBX(int indiceParaFilho1, int pai1, int pai2) {
        ...
        System.out.println("Como a taxa de crossover é " + taxaDeGenesQueSofreraoCrossover + " e o tamanho de um cromosso é "
                + (quantidadeDeGenes-1) + ", o crossover ocorrerá em " + crossoverRateSum + " genes.");
        }
        ...
        // Escolhendo as posições do cromossomo que sofrerão crossover. Vai até -1 pra não pegar a função de fitness
    ...
    public int torneio(){
        ...
        if (nivelDeVerbosidade>2) {
            ...
            System.out.println("Aptidão do primeiro sorteado = " + populacaoParaCrossover[individuo1][populacaoParaCrossover[0].length - 1]
                    + " e seu índice é " + individuo1);
            System.out.println("Aptidão do segundo sorteado = " + populacaoParaCrossover[individuo2][populacaoParaCrossover[0].length - 1]
                    + " e seu índice é " + individuo2);
        }
